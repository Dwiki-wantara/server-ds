...
type ArtisRepository interface {
	...
	UpdateArtis(artis models.Artis) (models.Artis, error)
	DeleteArtis(artis models.Artis) (models.Artis, error)
}
...
func (r *repository) UpdateArtis(artis models.Artis) (models.Artis, error) {
	err := r.db.Save(&artis).Error

	return artis, err
}

func (r *repository) DeleteArtis(artis models.Artis) (models.Artis, error) {
