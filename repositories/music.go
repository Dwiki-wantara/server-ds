...
type MusicRepository interface {
	...
	FindMusicById(ArtisID []int) ([]models.Artis, error)
...
func (r *repository) GetMusic(ID int) (models.Music, error) {
	...
	err := r.db.Preload("Artis").First(&music, ID).Error
...
func (r *repository) FindMusicById(ArtisID []int) ([]models.Artis, error) {
	var musik []models.Artis
	err := r.db.Find(&musik, ArtisID).Error
